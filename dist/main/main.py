...
import face_recognition  # helps with face recognition and comparison of data
import numpy as np
import cvzone
...
while True:
    ...
    facecurframe = face_recognition.face_locations(imgS)  # detection of face
    encodecurframe = face_recognition.face_encodings(imgS, facecurframe)  # distance of the face
